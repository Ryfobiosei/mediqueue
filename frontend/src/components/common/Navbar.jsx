        ...
        <div className="flex items-center gap-3">
          {!isAuthenticated ? (
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm font-medium text-[var(--text)]">Welcome, {user?.name}</span>
              <button
                onClick={handleLogout}
                className="bg-red-600 text-white hover:bg-red-700 font-semibold py-2 px-4 rounded-lg flex items-center gap-2 duration-200"
              >
                Logout
              </button>
            </div>
